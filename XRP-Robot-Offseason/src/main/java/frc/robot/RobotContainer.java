...
import frc.robot.commands.pathfindingCmd;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    m_drivetrain.setDefaultCommand(getPathfindingCommand());
  ...
  public Command getPathfindingCommand(){
    return new pathfindingCmd(m_drivetrain,m_ReflectanceSensor);
  }
}
